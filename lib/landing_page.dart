...
class _LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Lower ratio (e.g., 1.1) means taller cards for small screens
    // double dynamicAspectRatio = screenWidth < 360 ? 1.1 : 1.3;
        ...
        children: [
          ...
          Expanded(
            child: GridView.count(
              ...
              crossAxisSpacing: 10,
              mainAxisSpacing: 10,
              // Increase this number if you still see errors.
              // 1.0 is a square, 0.8 is a tall rectangle.
              ...
              children: [
                _buildCard(
                  ...
                  () => openWebsite("https://drive.google.com/drive/folders/1htUYAddsbrEAfRrqnLTzp8TnNZL1lE-v"),
                ),
                _buildCard(
                  '📋',
                  'Syllabus',
                  '4th sem CSE',
                  () => openWebsite("https://drive.google.com/drive/folders/1cK4ABqxP3qQ4kh4N-VtZFjXIcztBEhkd"),
                ),
                _buildCard(
                  '📝',
                  'Notes',
...
//                   ),
//                 ),
//                 _buildCard('⏰', 'Coming Soon', 'More features', () {
//                   context.go('/comingsoon');
//                 }),
//               ],
//             ),
...
// Widget _buildCard(String emoji, String title, String subtitle, VoidCallback onTap) {
//     return GridCard(
//       emoji: emoji,
//       title: title,
//       subtitle: subtitle,
